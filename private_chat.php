			...
			<div class="col-lg-3 col-md-4 col-sm-5"
				...
				foreach ($_SESSION['user_data'] as $key => $value) {
					...
					<div class="mt-3 mb-3 text-center">
						...
						<input type="button" class="btn btn-secondary mt-2 mb-2" id="logout" name="logout" value="Logout" />
					</div>
					<?php
				}
				?>
			...
			var html = `
					<div class="card">
						<div class="card-header">
							<div class="row">
								<div class="col col-sm-6">
									<b><span class="" id="chat_user_name">${user_name}</span></b>
								</div>
						...
						<div class="card-body" id="messages_area"> 
							<!-- This is the Chat History area with the selected user -->
						</div>
					</div>
					...
					<form id="chat_form" method="POST" data-parsley-errors-container="#validation_error">
						<div class="input-group mb-3" style="height:7vh">
							<textarea class="form-control" id="chat_message" name="chat_message" placeholder="Ketik Pesan" data-parsley-maxlength="1000" data-parsley-pattern="/^[a-zA-Z0-9\\s\?]+$/" required></textarea>
							<div class="input-group-append">
								<button type="submit" name="send" id="send" class="btn btn-success"><i class="fa fa-arrow-right"></i></button>
							</div>
						</div>
